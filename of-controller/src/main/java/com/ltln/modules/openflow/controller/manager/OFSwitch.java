...
import com.ltln.modules.openflow.controller.config.URIUtil;
...
import com.ltln.modules.openflow.controller.inf.SwitchDriverSubHandshakeAlreadyStarted;
import com.ltln.modules.openflow.controller.inf.SwitchDriverSubHandshakeCompleted;
import com.ltln.modules.openflow.controller.inf.SwitchDriverSubHandshakeNotStarted;
import com.ltln.modules.openflow.core.protocol.OFActionType;
import com.ltln.modules.openflow.core.protocol.OFBsnControllerConnection;
import com.ltln.modules.openflow.core.protocol.OFBsnControllerConnectionState;
import com.ltln.modules.openflow.core.protocol.OFBsnControllerConnectionsReply;
import com.ltln.modules.openflow.core.protocol.OFCapabilities;
...
import com.ltln.modules.openflow.core.protocol.OFFlowWildcards;
import com.ltln.modules.openflow.core.protocol.OFMessage;
import com.ltln.modules.openflow.core.protocol.OFPortConfig;
...
import com.ltln.modules.openflow.core.protocol.OFPortReason;
import com.ltln.modules.openflow.core.protocol.OFPortState;
...
public class OFSwitch implements IOFSwitchBackend {
	...
	public IOFConnection getConnection(LogicalOFMessageCategory category) {
		if (switchManager.isCategoryRegistered(category)) {
			...
			throw new IllegalArgumentException(category + " is not registered with the provider service.");
		}
	}
