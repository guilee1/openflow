...
import com.ltln.modules.openflow.controller.manager.OFChannelInitializer.PipelineHandler;
import com.ltln.modules.openflow.controller.manager.OFChannelInitializer.PipelineHandshakeTimeout;
import com.ltln.modules.openflow.controller.manager.OFChannelInitializer.PipelineIdleReadTimeout;
import com.ltln.modules.openflow.controller.manager.OFChannelInitializer.PipelineIdleWriteTimeout;
import com.ltln.modules.openflow.core.exceptions.OFParseError;
import com.ltln.modules.openflow.core.protocol.OFEchoReply;
import com.ltln.modules.openflow.core.protocol.OFEchoRequest;
...
import com.ltln.modules.openflow.core.protocol.OFFeaturesRequest;
import com.ltln.modules.openflow.core.protocol.OFHello;
import com.ltln.modules.openflow.core.protocol.OFHelloElem;
import com.ltln.modules.openflow.core.protocol.OFHelloElemVersionbitmap;
...
import com.ltln.modules.openflow.core.protocol.ver13.OFHelloElemTypeSerializerVer13;
import com.ltln.modules.openflow.core.protocol.ver14.OFHelloElemTypeSerializerVer14;
	...
	class CompleteState extends OFChannelState{
		...
		void enterState() throws IOException{
			...
			if (featuresReply.getVersion().compareTo(OFVersion.OF_13) < 0){
				connection = new OFConnection(featuresReply.getDatapathId(), factory, channel, OFAuxId.MAIN, timer);
			}
			// Handle 1.3 connections
			else {
				connection = new OFConnection(featuresReply.getDatapathId(), factory, channel, featuresReply.getAuxiliaryId(),  timer);
